    ...
    <div class="container-fluid">
        <div class="row clearfix">
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card mt-3">
                <div class="header">
                    <h2><strong>Delevery Success</strong> List </h2>
                </div>
                <div class="body">
                            ...
                            <tbody>
                                @foreach($order_list as $order)
                                  <tr>
                                    ...
                                    <td>
                                      <span class="badge badge-success">Delevired</span>
                                    </td>
                                    <td>
